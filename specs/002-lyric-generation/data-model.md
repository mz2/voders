...
| `languages` | list[str] | `["en-us"]` | espeak language codes to spread phonetic coverage across (multilingual eval match); one chosen per sample, seeded, recorded as `lyric_language` |
