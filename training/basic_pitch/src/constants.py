...
BASIC_PITCH_MAX_N_SEMITONES: int = int(
    math.floor(12.0 * math.log2(0.5 * SAMPLE_RATE / BASIC_PITCH_BASE_FREQUENCY))
)
BASIC_PITCH_DEFAULT_HARMONICS = [0.5, 1, 2, 3, 4, 5, 6, 7]
BASIC_PITCH_N_CONTOUR_BINS = BASIC_PITCH_N_SEMITONES * BASIC_PITCH_CONTOURS_BINS_PER_SEMITONE
