...
def create_datasets(
    ...
    print(f"\nLoading {dataset_name} ({data_path or 'default path'})")
...
def main():
    ...
    data_group.add_argument(
        ...
        type=str,
        default=None,
        help="Override the selected validation dataset's default path",
    )
    data_group.add_argument(
        "--train-groups",
        type=str,
    ...
    data_group.add_argument(
        ...
        type=str,
        default=None,
        help="Override the selected test dataset's default path",
    )
    data_group.add_argument(
        "--test-groups",
        type=str,
